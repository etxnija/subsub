...
void main() {
  group('Substitutes Sorting', () {
    ...
    setUp(() {
      // Create test players
      player1 = Player(id: '1', name: 'Player 1', number: 1);
      player2 = Player(id: '2', name: 'Player 2', number: 2);
      player3 = Player(id: '3', name: 'Player 3', number: 3);
    ...
    test('When bench times are equal, sorts by playing time (least first)', () {
      ...
      final benchStartTime = DateTime.now().subtract(
    ...
    test('Maintains order when both times are equal', () {
      ...
      final playStartTime = DateTime.now().subtract(
